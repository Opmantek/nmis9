...
# *****************************************************************************
#
# fixme9: this module should be completely replaced with text::csv
package Compat::CSV;
our $VERSION = "9.0.0a";
...
sub loadCSV {
	...
	if (sysopen(DATAFILE, "$file", O_RDONLY)) {
		...
		NMISNG::Util::logMsg("cannot open file $file, $!");
	}
...
sub writeCSV
{
	...
	#
	NMISNG::Util::setFileProt($file); # set file owner/permission, default: nmis, 0775
}
