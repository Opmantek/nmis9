...
# *****************************************************************************
#
package Compat::DBfunc;
# fixme9: this module should be removed, it's not used and is misleading
...
sub check{
	...
	# check DBI for error
	if ($DBI::err) {
		NMISNG::Util::logMsg("ERROR on DB ".$DBI::err.", ".$DBI::errstr) if $self->{logging};
