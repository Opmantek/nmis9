...
sub update_plugin
{
	...
	{
		$NG->log->debug("Running Alcatel ASAM plugin for Node '$node', Model '$catchall_data->{nodeModel}'.");
	}
	...
	$asamModel = $eqptHolderList->data_live->{eqptHolderPlannedType} || $catchall_data->{nodeModel};
