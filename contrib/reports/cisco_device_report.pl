#!/usr/bin/perl
#
## $Id: cisco_device_report.pl,v 1.1 2023/05/05 05:09:17 dougr Exp $
#
...
my $averagesw     = 0;
my $csvFile       = "cisco_device_report.csv";
my $debugsw       = -1;
my $helpsw        = 0;
my $interfacesw   = 0;
my $tsEnd         = 0;
...
my $dfltSubject   = "Cisco Device Report ". NMISNG::Util::returnDateStamp();
