...
#
# 2022-04-08 Added SHA2 support https://www.mail-archive.com/ports@openbsd.org/msg106148.html
...
our %EXPORT_TAGS = (
   authprotos => [
	  ...
	  UTH_PROTOCOL_HMACSHA384 AUTH_PROTOCOL_HMACSHA512 )
   ],
   levels     => [
   ...
   privprotos => [
      qw( PRIV_PROTOCOL_NONE PRIV_PROTOCOL_DES PRIV_PROTOCOL_AESCFB128
          ...
          PRIV_PROTOCOL_DRAFT_CISCO_AES192 PRIV_PROTOCOL_DRAFT_CISCO_AES256
          PRIV_PROTOCOL_DRAFT_CISCO2_AES192 PRIV_PROTOCOL_DRAFT_CISCO2_AES256)
   ],
);
...
sub PRIV_PROTOCOL_DRAFT_CISCO_AES192  { '1.3.6.1.4.1.9.12.6.1.1' }

# usmAES256CiscoPrivProtocol
sub PRIV_PROTOCOL_DRAFT_CISCO_AES256  { '1.3.6.1.4.1.9.12.6.1.2' }

# pysnmp/proto/secmod/eso/priv/aes192.py
# usmAES192Cisco2PrivProtocol
sub PRIV_PROTOCOL_DRAFT_CISCO2_AES192  { '1.3.6.1.4.1.9.12.6.1.101' }

# pysnmp/proto/secmod/eso/priv/aes256.py
# usmAES256Cisco2PrivProtocol
sub PRIV_PROTOCOL_DRAFT_CISCO2_AES256  { '1.3.6.1.4.1.9.12.6.1.102' }
   ...
   if ($security_level > SECURITY_LEVEL_NOAUTHNOPRIV) {
      ...
      if ($security_level > SECURITY_LEVEL_AUTHNOPRIV) {
         ...
         if (($this->{_priv_protocol} eq PRIV_PROTOCOL_AESCFB128)          ||
             ...
             ($this->{_priv_protocol} eq PRIV_PROTOCOL_DRAFT_CISCO_AES192) ||
             ($this->{_priv_protocol} eq PRIV_PROTOCOL_DRAFT_CISCO_AES256) ||
             ($this->{_priv_protocol} eq PRIV_PROTOCOL_DRAFT_CISCO2_AES192)||
             ($this->{_priv_protocol} eq PRIV_PROTOCOL_DRAFT_CISCO2_AES256))
         {
...

{
   my $protocols = {
      ...
      '(?:(?:(?:cfb)?128-?)?aes(?:-?128)?|aes128)',PRIV_PROTOCOL_AESCFB128,
      quotemeta PRIV_PROTOCOL_AESCFB128,           PRIV_PROTOCOL_AESCFB128,
      quotemeta PRIV_PROTOCOL_DRAFT_AESCFB128,     PRIV_PROTOCOL_AESCFB128,
      '(?:(?:(?:cfb)?192-?)aes(?:-?128)?|aes192)', PRIV_PROTOCOL_DRAFT_AESCFB192,
      quotemeta PRIV_PROTOCOL_DRAFT_AESCFB192,     PRIV_PROTOCOL_DRAFT_AESCFB192,
      '(?:(?:(?:cfb)?256-?)aes(?:-?128)?|aes256)', PRIV_PROTOCOL_DRAFT_AESCFB256,
      quotemeta PRIV_PROTOCOL_DRAFT_AESCFB256,     PRIV_PROTOCOL_DRAFT_AESCFB256,
      'aes192c',                                   PRIV_PROTOCOL_DRAFT_CISCO_AES192,
      quotemeta PRIV_PROTOCOL_DRAFT_CISCO_AES192,  PRIV_PROTOCOL_DRAFT_CISCO_AES192,
      'aes256c',                                   PRIV_PROTOCOL_DRAFT_CISCO_AES256,
      quotemeta PRIV_PROTOCOL_DRAFT_CISCO_AES256,  PRIV_PROTOCOL_DRAFT_CISCO_AES256,
      'aes192c2',                                  PRIV_PROTOCOL_DRAFT_CISCO2_AES192,
      quotemeta PRIV_PROTOCOL_DRAFT_CISCO2_AES192, PRIV_PROTOCOL_DRAFT_CISCO2_AES192,
      'aes256c2',                                  PRIV_PROTOCOL_DRAFT_CISCO2_AES256,
      quotemeta PRIV_PROTOCOL_DRAFT_CISCO2_AES256, PRIV_PROTOCOL_DRAFT_CISCO2_AES256,
   };
   ...
   sub _priv_protocol
   {
      ...
      if (($priv_proto eq PRIV_PROTOCOL_AESCFB128)          ||
          ...
          ($priv_proto eq PRIV_PROTOCOL_DRAFT_CISCO_AES192) ||
          ($priv_proto eq PRIV_PROTOCOL_DRAFT_CISCO_AES256) ||
          ($priv_proto eq PRIV_PROTOCOL_DRAFT_CISCO2_AES192)||
          ($priv_proto eq PRIV_PROTOCOL_DRAFT_CISCO2_AES256))
      {
...

{
   my $encrypt =
   {
      ...
      PRIV_PROTOCOL_DRAFT_CISCO_AES192,   \&_priv_encrypt_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO_AES256,   \&_priv_encrypt_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO2_AES192,  \&_priv_encrypt_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO2_AES256,  \&_priv_encrypt_aescfbxxx
   };
...

{
   my $decrypt =
   {
      ...
      PRIV_PROTOCOL_DRAFT_CISCO_AES192,   \&_priv_decrypt_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO_AES256,   \&_priv_decrypt_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO2_AES192,  \&_priv_decrypt_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO2_AES256,  \&_priv_decrypt_aescfbxxx
   };
...
sub _priv_data_init
{
   ...
   my $init =
   {
      ...
      PRIV_PROTOCOL_DRAFT_CISCO_AES192,   \&_priv_data_init_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO_AES256,   \&_priv_data_init_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO2_AES192,  \&_priv_data_init_aescfbxxx,
      PRIV_PROTOCOL_DRAFT_CISCO2_AES256,  \&_priv_data_init_aescfbxxx
   };
...
sub _priv_key_generate
{
   ...
   my $key_len =
   {
      ...
      PRIV_PROTOCOL_DRAFT_CISCO_AES192,   24,  # Draft AES in the USM Section 3.2.1
      PRIV_PROTOCOL_DRAFT_CISCO_AES256,   32,   # Draft AES in the USM Section 3.2.1
      PRIV_PROTOCOL_DRAFT_CISCO2_AES192,  24,  # Draft AES in the USM Section 3.2.1
      PRIV_PROTOCOL_DRAFT_CISCO2_AES256,  32   # Draft AES in the USM Section 3.2.1      
   };
...
sub _priv_key_validate
{
   ...
   my $key_len =
   {
      ...
      PRIV_PROTOCOL_DRAFT_CISCO_AES192,   [ 24, 'CFB128-AES-192' ],
      PRIV_PROTOCOL_DRAFT_CISCO_AES256,   [ 32, 'CFB128-AES-256' ],
      PRIV_PROTOCOL_DRAFT_CISCO2_AES192,  [ 24, 'CFB128-AES-192' ],
      PRIV_PROTOCOL_DRAFT_CISCO2_AES256,  [ 32, 'CFB128-AES-256' ]
   };
