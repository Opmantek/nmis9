...
trap_logit($traplog,"omk-rr1	UDP: [10.117.45.5]:49919-&gt;[10.117.3.154]:162	SNMPv2-MIB::sysUpTime.0=112:6:58:49.00	SNMPv2-MIB::snmpTrapOID.0=IF-MIB::linkUp	IF-MIB::ifIndex.566=566	IF-MIB::ifAdminStatus.566=up	IF-MIB::ifOperStatus.566=up	IF-MIB::ifName.566=xe-0/1/2");
