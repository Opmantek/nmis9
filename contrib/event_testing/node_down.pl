...
eventlog($eventlog,"meatball","Node Down","Major","","");
eventlog($eventlog,"ASGARD","Node Down","Major","","");
eventlog($eventlog,"bnelab-rr1","SNMP Down","Major","","No response from remote host \"10.248.0.1\"");
eventlog($eventlog,"bnelab-rr1","Node Configuration Change","Major","","Changed at 91 days 6:33:09");
