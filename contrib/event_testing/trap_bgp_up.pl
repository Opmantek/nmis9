...
trap_logit($traplog,"omk-core1	UDP: [10.117.45.5]:49919-&gt;[10.117.3.154]:162	SNMPv2-MIB::sysUpTime.0=62:18:49:42.81	SNMPv2-MIB::snmpTrapOID.0=BGP4-MIB::bgpTraps.0.2	BGP4-MIB::bgpPeerLastError.192.168.128.188=\"00 00 \"	BGP4-MIB::bgpPeerState.192.168.128.188=connect	SNMP-COMMUNITY-MIB::snmpTrapAddress.0=10.248.0.3	SNMP-COMMUNITY-MIB::snmpTrapCommunity.0=\"nothinghere\"	SNMPv2-MIB::snmpTrapEnterprise.0=BGP4-MIB::bgpTraps");
